...
module.exports = function (app) {
  app.route('/api/threads/:board')
    ...
    .get(async(req, res) => {
      ...
      const threads = await Thread.find({board: boardTitle}, ('-__v -reported -delete_password'))
    ...
    .post(async(req, res) => {
      ...
      res.redirect(`https://cv-board.glitch.me/b/${board}/`)
    })
  ...
  app.route('/api/replies/:board')
    ...
    .post(async(req, res) => {
      ...
      const thread = await Thread.findById(thread_id);
      const reply = { text, delete_password, reported: false };
      ...
      res.redirect(`https://cv-board.glitch.me/b/${board}/${thread_id}`)
    })
